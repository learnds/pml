...
```
Model 2 has a high error rate with accuracy of of < 50%. Again this does not fit the training data or the test data.
...
Let's see if the randomForest model the model can be compressed further by using Principal component analysis (PCA), 
